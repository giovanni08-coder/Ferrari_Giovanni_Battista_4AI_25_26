...
public class Gfg implements Serializable {
    ...
    // Drver Class
    // Main Function
    public static void Scrivi_binario(List<Personaggio>stringhe) throws Exception {
    ...
    public static void Leggi_binario() throws Exception {
        ...
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("data.bin"))) {
            List<Personaggio> stringhe = (List<Personaggio>) ois.readObject(); //oopure puoi mettere: inStream.readObject() ---> down-casting object

            // Stampa per verifica
            for (Personaggio s : stringhe) {
