public class Pedina {
    ...
    public void muovi(int nuovaRiga, int nuovaColonna) throws DamaException{
        muovi(nuovaRiga, nuovaColonna, false);
    }

    public void muovi(int nuovaRiga, int nuovaColonna, boolean mangiata) throws DamaException {
        ...
        if (riga !=0 && colonna!=0){
            ...
            //mi fido della scacchiara --> non va bene TODO
        }
        riga = nuovaRiga;
